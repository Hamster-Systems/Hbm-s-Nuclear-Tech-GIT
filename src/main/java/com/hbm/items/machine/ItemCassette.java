...
public class ItemCassette extends Item {
	...
	public enum TrackType {
		...
		BANK_ALARM("Bank Alarm", HBMSoundHandler.alarmBank, SoundType.LOOP, 3572962,
				100),
		...
		LOCK_DOWN("Lockdown Alarm", HBMSoundHandler.alarmLockDown, SoundType.LOOP, 0xDF3795, 500),
